...
class PixivNetworkModelTests(unittest.TestCase):
    ...
    def test_detail_rejects_login_only_and_returns_proxy_pages(self):
        raw = {"illustId":"93172108","title":"猫","userId":"2","userName":"作者","tags":{"tags":[{"tag":"猫"}]},"width":100,"height":80,"pageCount":1,"bookmarkCount":3,"createDate":"2021-01-01","xRestrict":0,"isMasked":False,"isUnlisted":False,"visibilityScope":0,"isLoginOnly":False,"illustType":1,"aiType":2,"urls":{"regular":"https://i.pximg.net/a.jpg","original":"https://i.pximg.net/b.jpg"}}
        ...
        self.assertEqual(item["workType"], "manga")
        self.assertTrue(item["aiGenerated"])
